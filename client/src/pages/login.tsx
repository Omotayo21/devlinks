    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-200">
      ...
      >
        ...
        <button
          onClick={loginAction}
          type="submit"
          className={`w-full cursor-pointer text-white bg-indigo-500 hover:bg-primary-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center ${
